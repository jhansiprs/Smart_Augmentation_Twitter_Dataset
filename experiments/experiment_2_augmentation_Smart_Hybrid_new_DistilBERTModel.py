...
def run_augmentation_experiment():
    ...
    results_dir = os.path.join(base_dir, 'results_augmented')
    ...
    results_path = os.path.join(results_dir, "all_results-Smart-DistilBERTModel.csv")
    ...
    recall_path = os.path.join(results_dir, "recall_table-Smart-DistilBERTModel.csv")

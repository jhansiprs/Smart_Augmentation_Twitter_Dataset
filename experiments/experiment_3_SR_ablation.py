...
def run_experiment():
    ...
    print("\nRunning Experiment 5: Ablation Study with Multi-Seed Evaluation for SR\n")
    ...
    results_dir = os.path.join(base_dir, 'results_exp3_ablation_multiseed_SR')

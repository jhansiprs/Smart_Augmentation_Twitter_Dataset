...
def run_baseline_experiment_all_models():

    print("Running Experiment 1: Baseline (All Models, Multiple Seeds)")
    ...
    results_dir = os.path.join(base_dir, 'results_experiment_1_baseline-DistilBERTModel')
    ...
    for seed in SEEDS:
        ...
        for model_class in model_classes:
            ...
            save_metrics(
                f"experiment1_{model_name}_seed{seed}",
                metrics,
    ...
    csv_path = os.path.join(results_dir, "experiment1_all_results-DistilBERTModel.csv")
...
if __name__ == "__main__":
    ...
    run_baseline_experiment_all_models()
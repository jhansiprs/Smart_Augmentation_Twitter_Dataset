...
def run_experiment():
    ...
    print("\nRunning Experiment 3: Ablation Study with Multi-Seed Evaluation for RI\n")
    ...
    results_dir = os.path.join(base_dir, 'results_exp5_ablation_multiseed_for_RI')
